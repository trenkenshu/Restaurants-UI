...
const RestaurantPage = () => {
    ...
    const saveRestaurant = async () => {
        ...
        if (typeof restaurant === 'string') {
            // console.log('rest string', restaurant);
            // console.log('12412', JSON.parse(restaurant));
            // navigate('/404');
            setIdError(true);
        } else {
    ...
    return (
        <>
            {idError && <Error404 />}
            {state.currentRestaurant && !idError && (
                        ...
                        <div className='flex flex-col items-center w-full h-full gap-2 pr-0.5'>
                            ...
                            <div className='flex items-center gap-2.5'>
                                <div className='px-2 py-1 border border-gray-400 rounded-full'>
                                    {state.currentRestaurant.workTimeStart}.00 - {state.currentRestaurant.workTimeEnd}
                                    .00
                                </div>
