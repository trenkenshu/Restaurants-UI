    ...
    return (
        <div className='flex flex-col w-full h-80 lg:h-96 border-b border-zinc-800 dark:border-corall'>
            <div className='w-full h-full overflow-y-hidden relative'>
                ...
                <div className='flex flex-col w-full h-4/5 bg-smoke-gray dark:bg-zinc-800 transition-all translate-y-64 lg:translate-y-80 duration-1000 hover:translate-y-24 p-2 cursor-pointer'>
